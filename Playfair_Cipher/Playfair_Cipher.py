...
if order == 1:
	...
	print("\nEncrypting... \n" + "Plaintext : " + message)
	print("\nBreak the message into digraphs : " + str(message_to_digraphs(message)))
	print("\nMatrix : " + str(matrix(key))) 
	print("\nCiphertext : " + str(encrypt(message)))
	...
	print("\nDecrypting... \n" + "Cipher: " + cipher)
	print("Plaintext : " + str(decrypt(cipher)).upper())
else:
	print("Error..!!")